    ...
    return (
        <section className=' w-full min-h-screen flex flex-col items-center justify-center'>
            <header className='text-center p-10'>
                <h1 className='text-6xl text-jeans font-bold mb-5'><span className='text-jeans'>Per<span className='text-vibrantgold'>Project</span></span> Manager</h1>
            ...
            <section className='flex gap-4'>
                <Button onClick={() => {navigate("/signup")}} className="bg-vibrantgold py-3 px-5">Sign Up</Button>
                <Button onClick={() => {navigate("/signin")}} className=" py-3 px-5">Log In</Button>
            </section>
        </section>
    )
