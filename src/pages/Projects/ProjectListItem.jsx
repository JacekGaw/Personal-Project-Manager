      ...
      <Modal ref={modalRef}>
        <div className="flex flex-col gap-2 items-center mb-5">
          ...
          <p className="text-md mb-5">
            Do you want to delete project "{projectInfo.Title}"?
          </p>
      ...
      <li className="group w-full rounded-md bg-white p-5 flex justify-between drop-shadow-sm hover:drop-shadow-md transition-all duration-200">
        <header>
          ...
          <div className="flex gap-2">
            ...
            <p className="text-xs font-[300] text-slate-700">
              Days left: {projectInfo && countDaysLeft(decodeTimestamp(projectInfo.plannedEndDate))}
            </p>
          </div>
          <div className="flex gap-2">
            <p className="text-xs font-[300] text-slate-700">
        ...
        <div className="flex gap-2">
          <div className="flex ">
            ...
            <button className=" flex justify-center items-center">
              <span
                className="material-symbols-outlined text-2xl opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300"
